...
_DEFAULT_INITIAL_PROMPT = (
    ...
    "write_todo only records status; it does NO work. Always actually CALL each "
    "step's tools before marking todos completed or saving the step report. In "
    "particular STEP_00 must really call parse_conditions, parse_documents, and "
